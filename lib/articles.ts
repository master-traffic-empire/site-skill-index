...
//
//   Done so far: frontend-developers, content-creators, graphic-designers, backend-engineers, ml-engineers, devops-engineers, data-analysts, marketers, qa-engineers, mobile-developers, technical-writers, solo-founders, product-managers, students, architects, junior-developers, freelancers
//   Next up: indie-hackers, security-engineers, sre-engineers, prompt-engineers, ai-engineers, research-engineers, growth-engineers, sales-engineers, customer-engineers
// ─────────────────────────────────────────────────────────────────
